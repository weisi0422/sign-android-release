    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (releaseFiles !== undefined) {
                ...
                // const signingKey = path_1.default.join(keystoreDirectory, 'signingKey.jks');
                ...
                for (let releaseFile of releaseFiles) {
                    ...
                    if (releaseFile.name.endsWith('.apk')) {
                        signedReleaseFile = yield signing_1.signApkFile(releaseFilePath, keystoreDirectory, aliasDecoded, keyStorePasswordDecoded, keyPasswordDecoded);   
                    }
